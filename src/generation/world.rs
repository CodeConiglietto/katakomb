...
pub fn gen_voxel(noise: OpenSimplex, meta_noise: OpenSimplex, x: usize, y: usize, z: usize) -> Voxel {
...
pub fn generate_chunk(offset: Point3<i32>, noise: OpenSimplex, meta_noise: OpenSimplex) -> Array3<Voxel>{
    let mut chunk = Array3::from_shape_fn(
